This repository features the Matlab source codes employed in a paper [1]. Please note that, among the 13 uploaded m-files, the underneath functions can be executed in Matlab to verify the results reported in [1, Sec. V]. 
